...
namespace Prototype.Web.Helpers
{
    ...
    public static class EnumerableExtensions
    {
        ...
        /// <param name="nameSelector">Lambda that specifies the name for the SelectList items</param>
        /// <param name="valueSelector">Lambda that specifies the value for the SelectList items</param>
        /// <param name="selectedItem">That item that should be selected</param>
        /// <returns>IEnumerable of SelectListItem</returns>
        public static IEnumerable<SelectListItem> ToSelectList<TItem, TValue>(this IEnumerable<TItem> items,
            Func<TItem, TValue> valueSelector,
            Func<TItem, string> nameSelector, TValue selectedItem)
            where TValue : class
        {
            return items.ToSelectList(valueSelector, nameSelector,
                                      x => selectedItem != null && selectedItem.Equals(valueSelector(x)));
        }
